//Tanging login system lang toh imma blow UP
...
int main() {
    ...
    // Add a demo student if none exist, so the program is easy to try.
    if (students.empty()) {
        Student demo;
        demo.username = "student1";
        demo.password = "pass123";
        demo.fullName = "Demo Student";
        demo.studentId = "S1001";
        students.push_back(demo);
        saveStudentsToFile();
    }
